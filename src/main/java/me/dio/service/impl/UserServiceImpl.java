...
public class UserServiceImpl implements UserService {
    ...
    // Construtor da classe que injeta o UserRepository necessário para acessar o banco de dados
    ...
    // Método privado para validar se o ID do usuário é alterável
    // Se o ID for inalterável, lança uma exceção BusinessException
